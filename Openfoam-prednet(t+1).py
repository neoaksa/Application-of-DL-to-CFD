...
# ------------
# Build and train PredNet(t+1) model
# this model only do 1 timestep prediction
# -------------
...
history = model.fit(x_all_samples, np.zeros(sample_size,np.float32), batch_size=batch_size, callbacks=callbacks,
